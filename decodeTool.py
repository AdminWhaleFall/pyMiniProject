...
LastEditTime: 2021-04-10 21:33:51
    ...
    while True:
        ...
        ###########################
            ...
            if put == "1":
                ...
                print("结果:", base64Encode(content))
            elif put == "2":
                content = input("请输入将要base64解密的字符串:")
                print("结果:", base64Decode(content))
            elif put == "3":
                content = input("请输入将要unicode编码的字符串:")
                print("结果:", unicodeDecode(content))
            elif put == "4":
                content = input("请输入将要unicode解码的字符串:")
                print("结果:", unicodeEecode(content))
            else:
                print("非预期输入!")
